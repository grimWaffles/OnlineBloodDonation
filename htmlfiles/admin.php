...
<head>
    ...
    <title>Admin-Online Blood Bank</title>
...
<body>
 ...
 <div class="modal fade" id="postmodal">
    ...
    include '../dbconn.php';
    //get active user
    $sql="SELECT username, astatus, type FROM userlogin WHERE astatus='active';";
    $result=mysqli_query($conn,$sql);
    while($row=mysqli_fetch_assoc($result)){
        $user=$row['username']; $type=$row['type'];
    }
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                <a href="../phpscripts/logincheck.php?login=changepass">Change Password</a><br>
                                                <a href="../phpscripts/logincheck.php?login=logout1" >Log-out</a><br>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <!--mainbody-->
        ...
        <br><br>
             <?php
             include '../dbconn.php';
               $sql="SELECT postid, fname, phone,location, quantity, status, date, bloodgroup FROM posts ORDER BY date";
               $result=mysqli_query($conn,$sql);
            ...
            <?php    while($row=mysqli_fetch_assoc($result)){ ?>
                ...
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <a href="mailto:waziullah@live.com" class="card-link"><b>Email</b></a>
                    </div>
                </div>
